...
| **`test_categories_management.py`** | Gestión y eliminación de categorías | Creación, actualización en cascada de categorías en productos y borrado seguro con validación. |
